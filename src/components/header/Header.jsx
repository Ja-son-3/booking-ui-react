                    ...
                    <>
                        ...
                        <div className="headerSearch">
                            ...
                            <div className="headerSearchItem">
                                ...
                                <span onClick={() => setOpenOptions(!openOptions)} className="headerSearchText">{`${options.adult} ${options.adult > 1 ? "adults" : "adult"} · ${options.children} children · ${options.room} ${options.room > 1 ? "rooms" : "room"}`}</span>
                                {openOptions &&
